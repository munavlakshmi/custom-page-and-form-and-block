...
namespace Drupal\cp\Plugin\Block;
...
class CustomBlock extends BlockBase implements BlockPluginInterface {
   ...
   * {@inheritdoc}
   */
  //this is need when to form dispaly in block
  /**public function build() {
    //$build = [];
    //$build['id_custom_block']['#markup'] = 'This is a custom block in the region sidebar second';
    $form = \Drupal::formBuilder()->getForm('Drupal\cp\Form\CustomForm');
